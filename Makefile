SRCS =			dispatchflag.c ft_printf.c ft_putchar.c ft_putnbr_base.c ft_putnbr.c ft_putptr.c ft_putstr.c ft_putuns.c strcreate.c validateflag.c ft_putptr_base.c
